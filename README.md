...
KENTECH Digital House Sorting은 신입생들에게 **마법 같은 기숙사 배정 경험**을 제공하기 위해 개발된 웹 애플리케이션입니다. 해리포터의 '기숙사 배정 모자'에서 영감을 받아, 영화 같은 연출과 인터랙티브한 UI를 통해 단순한 '확인' 과정을 하나의 '이벤트'로 만들었습니다.

| 문제 | 해결 |
|------|------|
| 지루한 배정 확인 | 밤하늘의 별, 웅장한 사운드, 전율이 흐르는 결과 화면 연출 |
...
|:---:|:---:|:---:|
| ![중앙](./screenshot/중앙%20호버.png) | ![왼쪽](./screenshot/왼쪽%20호버%20에디슨.png) | ![오른쪽](./screenshot/오른쪽%20호버%20테슬라.png) |

### 2. 로딩 및 결과 (Loading & Result)
긴장감을 주는 로딩 화면과 웅장한 기숙사 배정 결과를 보여줍니다.
...
- **중복 방지**: 이미 배정받은 학생은 기존 배정 결과를 반환합니다.
- **배정 동의**: 사용자의 배정 동의 여부를 확인하고 기록합니다.
